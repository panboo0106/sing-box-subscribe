...
```
https://xxxxxxx.vercel.app/config/https://xxxxxxsubscribe?token=123456&file=https://github.com/Toperlock/sing-box-subscribe/raw/main/config_template/streaming/tun.json
```
...
A lazy configuration `streaming/tun.json` file is included, which allows filtering nodes based on different categories:
